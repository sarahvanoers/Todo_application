...
<body>
  ...
  <span class="navbar-toggler-icon">
    ...
    <?php include_once("components/taskCreate.php") ?>
    <div class="row">
      
            <div class="col-4 left">
                <h1 class=username>Hi, Sarah Van Oers</h1>
                <h2>List overview</h2>
                <a class="nav-item nav-link" href="listCreate.php" data-toggle="modal" data-target="#exampleModalCenter2">Add list</a>
                <?php include_once("components/listCreate.php") ?>
